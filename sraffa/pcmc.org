...
#+DATE:      <2013-01-17 Mo>
#+LANGUAGE:  en
#+STYLE:     <style>body { font-family: "Palatino Linotype", Palatino, Palladio, "URW Palladio L", "Book Antiqua", Baskerville, "Bookman Old Style", "Bitstream Charter", "Nimbus Roman No9 L", Garamond, "Apple Garamond", "ITC Garamond Narrow", "New Century Schoolbook", "Century Schoolbook", "Century Schoolbook L", Georgia, serif; }</style>
#+STYLE:     <style>li {line-height: 23px;} body { width: 600px; line-height: 23px; }</style>
...
- Lets revise our example from \sect[[section_1][1]] to have a surplus:
  ...
  condition, and the rate of profit is /r/ = 0.25%
...
- The certeria is: does a ccommodity enter (either directly or
...
- Sraffa argues a "less one-sided description than cost of production
  ...
  - Classical terms such as "necessary price", "natural price", or
    "price of production" would meet the case
...
- We shall hereafter *assume* the wage is paid /post factum/ as a share
  of the annual product. Thus we *abandon* the classical economists'
  idea of a wage "advanced" from capital.
...
# <<section_12>>
- The national income of a system in a self-replacing state consists of
  the set of commodities which are "left over" after the articles
  replacing the means of production are used up.
...
# <<section_26>>
- We shall call this sort of mixture the *Standard composite commodity*,
...
- Such a unit we shall call the *Standard net product* or *Standard national income*.
...
# <<section_28>>
- The rate which applies to individual commodities *is* also the
